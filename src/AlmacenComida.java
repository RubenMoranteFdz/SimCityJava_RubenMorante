	...
	public synchronized boolean solicitarComida(int cantidadComida,String ciudad) {
		try {
			if(cantidadComida<=this.totalComida) {
				//AQUÍ FALTA CÓDIGO //simulamos la preparación de la comida multiplicando la cantidad solicitada por 10 milisegundos
				Thread.sleep(10*cantidadComida);	//<-código que faltaba			
				//AQUÍ FALTA CÓDIGO //restamos del total de comida la comidasolicitada
				totalComida=totalComida-cantidadComida; //<-código que faltaba
